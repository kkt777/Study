...
public class Task2_10 {
    ...
    public static void main(String[] args) {
        ...
        String[] fruitus = {"りんご","ぶどう","メロン"};

        // ② for文を使って①で作成した配列を出力しなさい。
        for (int i = 0; i < fruitus.length; i++) {
            System.out.println(fruitus[i]);
        }
        // ③ 以下のwhile文の処理について、何をしているのかコメントを記入してください。
        /*
            1から50までの数字を順番に出力する処理。変数iを1からスタートし、iが50以下の間ループを繰り返し、iを出力して1ずつ増やしている。
        */
        int i = 1;
        while(i <= 50) {
            System.out.print(i);
